...
static const struct known_urls_st known_urls[] = {
	...
	LL("/1/Linux", get_platform_handler, NULL),
	LL("/1/Linux_64", get_platform_handler, NULL),
	LL("/1/Windows", get_platform_handler, NULL),
	LL("/1/Windows_ARM64", get_platform_handler, NULL),
	LL("/1/Darwin_i386", get_platform_handler, NULL),
	LL("/1/binaries/vpndownloader.sh", get_dl_handler, NULL),
	LL("/1/binaries/vpndownloader.exe", get_dl_handler, NULL),
	LL("/1/VPNManifest.xml", get_string_handler, NULL),
	LL("/1/VPNHashManifest.xml", get_string_handler, NULL),
	LL("/1/binaries/update.txt", get_string_handler, NULL),
	LL_DIR("/1/binaries", get_anyconnect_binary_handler, NULL),
