...
#define REASON_SERVER_SHUTDOWN 10
...
typedef enum {
	...
	CMD_SECM_TERMINATE_USER_SESSIONS,
	CMD_SECM_TERMINATE_USER_SESSIONS_REPLY,
	CMD_SECM_TERMINATE_SESSION,
	CMD_SECM_TERMINATE_SESSION_REPLY,
